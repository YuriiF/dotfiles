...
wsl -d Ubuntu -u root -- curl -fsSL https://raw.githubusercontent.com/YuriiF/dotfiles/main/install.sh | bash
```
...
- GitHub Issues: [Repository Issues](https://github.com/YuriiF/dotfiles/issues)
