...
[#863](https://github.com/YuriiF/dotfiles/issues/863).
...
[`scripts/diagnostics/perf.sh`](https://github.com/YuriiF/dotfiles/blob/main/scripts/diagnostics/perf.sh) —
...
[`.github/workflows/perf-baseline.yml`](https://github.com/YuriiF/dotfiles/blob/main/.github/workflows/perf-baseline.yml)
...
- [`scripts/diagnostics/perf.sh`](https://github.com/YuriiF/dotfiles/blob/main/scripts/diagnostics/perf.sh)
- [`tests/unit/diagnostics/test_perf_percentiles.sh`](https://github.com/YuriiF/dotfiles/blob/main/tests/unit/diagnostics/test_perf_percentiles.sh) — percentile math contract
- [`.github/workflows/perf-baseline.yml`](https://github.com/YuriiF/dotfiles/blob/main/.github/workflows/perf-baseline.yml)
- ADR-002 (Shell Performance Optimization)
- Issue [#863](https://github.com/YuriiF/dotfiles/issues/863)
