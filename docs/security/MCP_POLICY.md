...
The source of truth lives in [mcp-policy.json](https://github.com/YuriiF/dotfiles/blob/main/defaults/dot_config/dotfiles/mcp-policy.json).
Approved package pins live in [mcp-lock.json](https://github.com/YuriiF/dotfiles/blob/main/defaults/dot_config/dotfiles/mcp-lock.json).
Tracked server registry entries live in [mcp-registry.json](https://github.com/YuriiF/dotfiles/blob/main/defaults/dot_config/dotfiles/mcp-registry.json).
...
Policy bundle baselines live in [policy-bundles.json](https://github.com/YuriiF/dotfiles/blob/main/defaults/dot_config/dotfiles/policy-bundles.json).
