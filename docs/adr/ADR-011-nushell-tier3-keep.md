...
- [`dot_config/nushell/cached_eval.nu`](https://github.com/YuriiF/dotfiles/blob/main/defaults/dot_config/nushell/cached_eval.nu) — the new module.
- [`dot_config/nushell/env.nu.tmpl`](https://github.com/YuriiF/dotfiles/blob/main/defaults/dot_config/nushell/env.nu.tmpl) — adopter.
...
- Issue [#880](https://github.com/YuriiF/dotfiles/issues/880).
