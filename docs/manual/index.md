...
This manual is generated from the Markdown sources in [`docs/manual/`](https://github.com/YuriiF/dotfiles/tree/main/docs/manual) and published in nine formats per release. The HTML edition you are reading is the canonical online version.

## Read it your way

- **Web (multi-page)** — browse the chapters below
- **Single-page HTML, PDF, EPUB, ASCII text** — attached to every [GitHub Release](https://github.com/YuriiF/dotfiles/releases/latest)
